...
/**
 * TEMPORARY: this is the Style Guide screen — a living reference for the
 * design system, not a real app screen. It exists so you can run the app
 * right now and SEE the colors, type scale, and components render for real,
 * before we build the actual quiz/onboarding flow on top of them.
 *
 * Once the real navigation is built, this moves to a dev-only route.
 */
