...
export const contentLibrary: ContentSection[] = [
  ...
  },
  {
    ...
    tags: ['hotFlashes:weekly', 'hotFlashes:daily', 'hotFlashes:multiple-daily'],
  },
  {
    slug: 'body-literacy',
    title: 'Body Literacy',
    ...
    tags: ['goal:understand', 'stage:unsure', 'symptomDuration:unsure'],
  },
  {
    slug: 'movement',
    title: 'Movement',
    ...
    tags: ['activity:rarely', 'activity:not-active', 'activity:sometimes'],
  },
  {
    slug: 'nutrition',
    title: 'Nutrition',
    ...
    tags: ['goal:feel-better', 'hotFlashes:daily', 'hotFlashes:multiple-daily'],
  },
  {
    slug: 'sleep',
    title: 'Sleep',
    ...
    tags: ['sleep:occasional', 'sleep:frequent', 'sleep:rare-good-night'],
  },
  {
    slug: 'sexual-health',
    title: 'Sexual Health',
    ...
    tags: ['bodyRelationship:frustrated', 'bodyRelationship:grieving', 'goal:understand'],
  },
  {
    ...
    tags: ['mood:some-ups-downs', 'mood:noticeable-swings', 'mood:significant'],
  },
  {
    ...
    tags: ['doctorConversation:not-yet', 'doctorConversation:planning'],
  },
  {
    slug: 'hrt-education',
    title: 'HRT Education',
    ...
    tags: ['currentSupport:unsure', 'hrtInterest:considering', 'hrtInterest:unfamiliar'],
  },
  {
    ...
    tags: ['bodyRelationship:grieving', 'bodyRelationship:figuring-out', 'bodyRelationship:curious'],
  },
];
